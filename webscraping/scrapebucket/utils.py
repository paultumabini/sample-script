...
"""
The followings are custom functions that deal with API.
Some variables are hard-coded for their parameters or cookies.
"""

# URLS,Cosette Provider,Oregan Dealers
